...
ActiveRecord::Schema[7.0].define(version: 2023_11_30_185904) do
  ...
  create_table "tag_potins", force: :cascade do |t|
    t.bigint "tag_id"
    t.bigint "potin_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["potin_id"], name: "index_tag_potins_on_potin_id"
    t.index ["tag_id"], name: "index_tag_potins_on_tag_id"
  end
